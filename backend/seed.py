...
COURSES = [
    {"id": "CS101", "name": "Introduction to Computer Science", "credits": 3, "difficulty": "beginner",
    ...
    {"id": "CS201", "name": "Data Structures and Algorithms", "credits": 4, "difficulty": "intermediate",
    ...
    {"id": "CS301", "name": "Machine Learning", "credits": 3, "difficulty": "advanced",
    ...
    {"id": "CS350", "name": "Web Development", "credits": 3, "difficulty": "intermediate",
    ...
    {"id": "CS250", "name": "Database Systems", "credits": 3, "difficulty": "intermediate",
    ...
    {"id": "MATH100", "name": "Calculus I", "credits": 4, "difficulty": "beginner",
    ...
    {"id": "MATH200", "name": "Linear Algebra", "credits": 3, "difficulty": "intermediate",
    ...
    {"id": "ENG101", "name": "English Composition", "credits": 3, "difficulty": "beginner",
     "prerequisites": [], "description": "Academic writing, research, and critical analysis.",
     "topics": ["writing", "communication"], "department": "English"},
    {"id": "PHY101", "name": "Physics I", "credits": 4, "difficulty": "intermediate",
